...
def depth2pcd(depth, img, cam_intrinsics):
    ...
    for u in range(h):
        for v in range(w):
            ...
            depth_point = depth2pcd_point(uvz_point, cam_intrinsics,
                                          rgb_colour_point)
...
def depth2pcd_posed(depth, img, cam_intrinsics, cam_pose):
    ...
    total_pcd_array_aug = np.concatenate([total_pcd_array,
                                          np.ones((total_points, 1))], axis=1)
...
def create_point_cloud(frame_depth, frame_img, frame_intrinsics, frame_pose, save_name='cluster1.ply'):
    '''
    ...
    frame_pcd = depth2pcd_posed(frame_depth, frame_img, frame_intrinsics,
                                frame_pose)
